...
var G__21990 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21990;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21991 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21991,ch);
...
if(("\\" === ch__$1)){
var ch_21992__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21992__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21992__$2);
} else {
}

var G__21993 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__21993;
continue;
}
}
...
var vec__22001 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22001,(0),null);
var start_column = cljs.core.nth.call(null,vec__22001,(1),null);
...
var G__22004 = cljs.core.conj_BANG_.call(null,a,form);
a = G__22004;
continue;
}
}
...
var _STAR_read_delim_STAR_22005 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_22005;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__22006 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22006,(0),null);
var start_column = cljs.core.nth.call(null,vec__22006,(1),null);
...
var vec__22009 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22009,(0),null);
var end_column = cljs.core.nth.call(null,vec__22009,(1),null);
...
var vec__22012 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22012,(0),null);
var start_column = cljs.core.nth.call(null,vec__22012,(1),null);
...
var vec__22015 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22015,(0),null);
var end_column = cljs.core.nth.call(null,vec__22015,(1),null);
...
var vec__22018 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__22018,(0),null);
var start_column = cljs.core.nth.call(null,vec__22018,(1),null);
...
var vec__22021 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22021,(0),null);
var end_column = cljs.core.nth.call(null,vec__22021,(1),null);
...
var sb = (function (){var G__22024 = (new goog.string.StringBuffer());
G__22024.append(initch);
...
var G__22026 = (function (){var G__22025 = sb;
G__22025.append(ch);
...
switch (G__22030) {
case "\\":
var G__22034 = (function (){var G__22031 = sb;
G__22031.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__22031;
})();
var G__22035 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22034;
ch = G__22035;
continue;
...
break;
default:
var G__22036 = (function (){var G__22032 = sb;
G__22032.append(ch);

return G__22032;
})();
var G__22037 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__22036;
ch = G__22037;
continue;
...
var vec__22038 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__22038,(0),null);
var end_column = cljs.core.nth.call(null,vec__22038,(1),null);
...
var vec__22041 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22041,(0),null);
var column = cljs.core.nth.call(null,vec__22041,(1),null);
...
var vec__22046 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22046,(0),null);
var column = cljs.core.nth.call(null,vec__22046,(1),null);
...
var vec__22051 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__22051,(0),null);
var column = cljs.core.nth.call(null,vec__22051,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__22062 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__22062,true,null,opts,pending_forms);
...
var G__22063 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__22063)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__22063)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__22063)){
...
var _STAR_suppress_read_STAR_22064 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22064;
}});
...
var G__22065 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__22065,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__22065,rdr,first_line);
...
var G__22069 = matched;
var G__22070 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__22069;
finished = G__22070;
continue;
} else {
...
var _STAR_suppress_read_STAR_22071 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_22071;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env22072 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__22073 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__22073,"(");
...
var G__22074 = (i + (1));
var G__22075 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env22072;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__22076 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__22076);
...
var G__22077 = cljs.core.next.call(null,s__$1);
var G__22078 = ret;
s__$1 = G__22077;
r = G__22078;
continue;
...
var G__22079 = cljs.core.next.call(null,s);
var G__22080 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__22079;
key_vals = G__22080;
continue;
} else {
...
var gensym_env22084 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env22084;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__22085 = token;
var G__22085__$1 = (((G__22085 == null))?null:cljs.core.subs.call(null,G__22085,(1)));
var G__22085__$2 = (((G__22085__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22085__$1));
var G__22085__$3 = (((G__22085__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22085__$2));
var G__22085__$4 = (((G__22085__$3 == null))?null:cljs.core.symbol.call(null,G__22085__$3));
if((G__22085__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__22085__$4);
}
})():(function (){var G__22086 = token;
var G__22086__$1 = (((G__22086 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__22086));
if((G__22086__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__22086__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e22093){if((e22093 instanceof Error)){
var e = e22093;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__22097,reader){
...
var eof = cljs.core.get.call(null,map__22098__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4499__auto___22106 = arguments.length;
var i__4500__auto___22107 = (0);
while(true){
if((i__4500__auto___22107 < len__4499__auto___22106)){
args__4502__auto__.push((arguments[i__4500__auto___22107]));

var G__22108 = (i__4500__auto___22107 + (1));
i__4500__auto___22107 = G__22108;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq22104){
var G__22105 = cljs.core.first.call(null,seq22104);
var seq22104__$1 = cljs.core.next.call(null,seq22104);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22105,seq22104__$1);
});


//# sourceMappingURL=reader.js.map?rel=1528479343972
