...
return (new CustomEvent(event_name,(function (){var obj27239 = {"detail":data};
return obj27239;
})()));
} else {
...
var f = (function (){var pred__27246 = cljs.core._EQ_;
var expr__27247 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27246.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27247))){
return ((function (pred__27246,expr__27247){
return (function (p1__27240_SHARP_){
return console.warn(p1__27240_SHARP_);
});
;})(pred__27246,expr__27247))
} else {
if(cljs.core.truth_(pred__27246.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27247))){
return ((function (pred__27246,expr__27247){
return (function (p1__27241_SHARP_){
return console.debug(p1__27241_SHARP_);
});
;})(pred__27246,expr__27247))
} else {
if(cljs.core.truth_(pred__27246.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27247))){
return ((function (pred__27246,expr__27247){
return (function (p1__27242_SHARP_){
return console.error(p1__27242_SHARP_);
});
;})(pred__27246,expr__27247))
} else {
return ((function (pred__27246,expr__27247){
return (function (p1__27243_SHARP_){
return console.log(p1__27243_SHARP_);
});
;})(pred__27246,expr__27247))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27250){
...
var eval_fn = cljs.core.get.call(null,map__27251__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27253_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27255,(0),null);
...
}catch (e27260){if((e27260 instanceof Error)){
var e = e27260;
return not_found;
} else {
throw e27260;
...
//# sourceMappingURL=utils.js.map?rel=1528479350178
